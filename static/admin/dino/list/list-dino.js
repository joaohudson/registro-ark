(function(){
    ...
    async function loadData(){
        ...
        for(const obj of data){
            ...
            changeButton.onclick = () => location.href = '/admin/dino/change?id=' + obj.id;
            changeButton.innerText = '✏️';
            changeButton.title = 'Alterar dino';
            changeButton.className = 'actionButton';
            actionsTd.appendChild(changeButton);
